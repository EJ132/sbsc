...
export default class PhysicalTherapy extends Component {
    ...
    render(){
        return(
            <Container className="pt-5 mt-5">
                ...
                <Row xs={1} md={1} lg={2}>
                    <Col>
                        <Image src={pt} fluid rounded className="main-service-img" style={{objectPosition: "0px 5%"}} />
                    </Col>
                    <Col>
                        <h1 className="h1 service-header text-left">Physical Therapy</h1>
                        <h1 className="service-desc-h5 text-left">Get professional physical therapy with Dr. Ashley Contorno.</h1>
                        <Button variant="outline-warning py-2 px-3 my-3" onClick={() => this.navigateTo('/services/schedule-pt')}>Get Physical Therapy</Button>
                    </Col>
                </Row>
